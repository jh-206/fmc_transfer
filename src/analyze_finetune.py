# Executable module to analyze results of transfer learning, no twarp and no frozen layers
# Requires existing output: outputs/fine_tune_reps
...
if __name__ == '__main__':
    ...
    reps_dir = "outputs/fine_tune_reps"
    if not osp.exists(reps_dir):
        print(f"Can't find required output directory: {reps_dir}")
        sys.exit(-1)

    print(f"Summarizing Transfer Fine-Tune from directory: {reps_dir}")
