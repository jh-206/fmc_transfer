...
if __name__ == '__main__':
    if len(sys.argv) not in [2, 3]:
        ...
        print("Example: python src/transfer_twarp_finetune.py etc/thesis_config.yaml")
        print("Example: python src/transfer_twarp_finetune.py etc/thesis_config.yaml 17")
        sys.exit(-1)
